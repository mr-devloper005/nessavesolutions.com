...
const base = {
  ...
  accentSoft: '#eef2ff',
  onAccent: '#ffffff',
  glow: 'rgba(59,73,223,0.08)',
  radius: '0.375rem',
} satisfies Omit<TaskTheme, 'kicker' | 'note'>

export const taskThemes: Record<TaskKey, TaskTheme> = {
  article: { ...base, kicker: 'Articles', note: 'In-depth reads, guides, and practical ideas worth your time.' },
  listing: { ...base, kicker: 'Businesses', note: 'Find, compare, and connect with useful business pages.' },
  ...
  profile: { ...base, kicker: 'People', note: 'Discover creators, businesses, freelancers, and professional profiles.' },
}
