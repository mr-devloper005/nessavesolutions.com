...
export const editableRootStyle = {
  // DEV-inspired editorial system: white chrome, soft gray gutters, black logo,
  // indigo action outline, and readable near-black text.
  '--slot4-page-bg': '#f5f5f5',
  '--slot4-page-text': '#242424',
  '--slot4-panel-bg': '#f3f4f6',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#575757',
  '--slot4-soft-muted-text': '#717171',
  '--slot4-accent': '#3b49df',
  '--slot4-accent-fill': '#3b49df',
  ...
  '--editable-page-text': '#242424',
  '--editable-container': '1368px',
  '--editable-border': '#d6d6d7',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#242424',
  '--editable-nav-active': '#3b49df',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#ffffff',
  '--editable-cta-text': '#3b49df',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#f5f5f5',
  '--editable-footer-text': '#242424',
} as CSSProperties
